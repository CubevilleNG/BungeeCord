...
public class DownstreamBridge extends PacketHandler
{
    ...
    public void handle(net.md_5.bungee.protocol.packet.Team team) throws Exception
    {
        ...
        if ( !con.getServer().getInfo().getName().equalsIgnoreCase( "amongus" ) && !con.getServer().getInfo().getName().equalsIgnoreCase( "bedwars" ) && !team.getName().startsWith( "LD_" ) && !team.getName().startsWith( "CIT-" ) )
        {
